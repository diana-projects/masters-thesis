...
def vox2pix(cam_E, cam_k, 
    ...
    # so technically the bounds would be -> 51.2, 25.6, 4.4; which is fair i saw that in semantickitti that is how the scene is (in meters!) 
    vol_bnds[:,1] = vox_origin + np.array(scene_size)

    # Compute the voxels centroids in lidar cooridnates
    # basically scene_size/voxel_size -> voxel_size is 0.2meters, you need to calculate the number of voxels in the scene per dimension
    ...
    # this created the scene with voxel centroids (like coordinates are the middle of each voxel)
