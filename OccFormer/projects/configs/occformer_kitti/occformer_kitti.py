...
model = dict(
    ...
    img_bev_encoder_neck=dict(
        ...
        positional_encoding=dict(type="SinePositionalEncoding3D", num_feats=voxel_out_channels // 3, normalize=True),
    ),
    pts_bbox_head=dict(
        ...
        positional_encoding=dict(type="SinePositionalEncoding3D", num_feats=mask2former_pos_channel, normalize=True),
    ...
    test_cfg=dict(pts=dict(semantic_on=True, panoptic_on=False, instance_on=False)),
)
...
train_pipeline = [
    ...
    dict(type="LoadSemKittiAnnotation", bda_aug_conf=bda_aug_conf, is_train=True, point_cloud_range=point_cloud_range),
    dict(type="OccDefaultFormatBundle3D", class_names=class_names),
    dict(type="Collect3D", keys=["img_inputs", "gt_occ"], meta_keys=["pc_range", "occ_size"]),
]
...
test_pipeline = [
    ...
    dict(type="LoadSemKittiAnnotation", bda_aug_conf=bda_aug_conf, is_train=False, point_cloud_range=point_cloud_range),
